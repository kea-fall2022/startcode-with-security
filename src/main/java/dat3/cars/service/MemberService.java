...
public class MemberService {
 ...
 public void editMember(MemberRequest body, String username){
  ...
  public List<MemberResponse> getMembers(boolean includeAll, boolean includeReservations) {
    ...
    List<MemberResponse> response = members.stream().map(member -> new MemberResponse(member,includeAll,includeReservations)).collect(Collectors.toList());
  ...
  public MemberResponse findMemberByUsername(@PathVariable String username) throws Exception {
    ...
    return new MemberResponse(found,false,true);
  }
