...
public class MemberController {
  ...
  //Security ADMIN
  @GetMapping()
  public List<MemberResponse> getMembers(@RequestParam(required = false) String includeReservations){
    boolean includeRes= includeReservations!=null ? true: false;
    List<MemberResponse> res = memberService.getMembers(true,includeRes);
    return res;
  }
